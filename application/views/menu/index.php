                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($menu as $m) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $m['menu']; ?> </td>
                                                    <td>
                                                        <a href="" class="btn btn-success" data-toggle="modal" data-target="#exampleModaledit<?= $m['id'] ?>">Edit</a>
                                                        <a href="" class="btn btn-danger" data-toggle="modal" data-target="#exampleModaldelete<?= $m['id'] ?>">Delete</a>
                                                    </td>
                                                </tr>
                                                <!-- Update Modal Menu -->
                                                <div class="modal fade" id="exampleModaledit<?= $m['id'] ?>" tabindex="-1" role="dialog">
                                                ...
                                                <!-- Delete Modal Menu -->
                                                <div class="modal fade" id="exampleModaldelete<?= $m['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <form action="<?= base_url('menu/deletemenu'); ?>" method="post">
                                                                <input type="hidden" name="id" value="<?= $m['id'] ?>">
                                                                <div class="modal-body">
                                                                    Are you sure?, you deleted the menu <strong><span class="text-danger"><?= $m['menu'] ?></span></strong>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
